...
public class AccidentController {
    ...
    @RequestMapping(value = CREATE_EVENT, method = RequestMethod.POST, produces = "application/json")
    @ResponseBody
    public void createEvent(@RequestBody WebAccident accident) {
        service.createEvent(accident);
    }

    @RequestMapping(value = GET_EVENT_BY_ADDRESS_AND_PERIOD, method = RequestMethod.POST, produces = "application/json")
    @ResponseBody
    public List<WebAccident> getEventByAddressAndPeriod(@RequestBody AddressAndPeriodRequest addressAndPeriodRequest) {
    ...
    @ResponseBody
    public List<WebAccident> getGetEventByAddressAndDate(@RequestBody AddressAndDateRequest addressAndDateRequest) {
    ...
    @ResponseBody
    public List<WebAccident> getGetEventByAddress(@PathVariable String address) {
